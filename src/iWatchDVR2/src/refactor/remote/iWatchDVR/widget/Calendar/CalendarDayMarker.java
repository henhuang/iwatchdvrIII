...
public class CalendarDayMarker {
	...
	public void setDate(Calendar c/*, View v*/)
	{
		init(c.get(Calendar.YEAR), c.get(Calendar.MONTH), c.get(Calendar.DAY_OF_MONTH), _color);
		//_marked.setBackgroundColor(Color.RED);
