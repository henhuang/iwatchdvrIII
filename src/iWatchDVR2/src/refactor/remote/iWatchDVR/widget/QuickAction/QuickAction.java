package refactor.remote.iWatchDVR.widget.QuickAction;
...
public class QuickAction extends PopupWindows {
	...
	protected OnActionItemClickListener mListener;
	...
	*/
	...
	public void show (View anchor) {
		...
		mRootView.setLayoutParams(new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
		...
		if ((anchorRect.left + rootWidth) > screenWidth)
			...
			xPos = (anchor.getWidth() > rootWidth) ? anchorRect.centerX() - (rootWidth/2) : anchorRect.left;
		...
		showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), xPos > 0 ? anchorRect.centerX()-xPos : anchorRect.centerX());
	...
	/**
	 * Holder for item to save needed data, using with getTag()
	 *
	 */
	protected class ActionItemExtraHolder {
		
		int mIndex = -1;
		
		public ActionItemExtraHolder() {
		}
		
		public ActionItemExtraHolder(int index) {
			mIndex = index;
		}
